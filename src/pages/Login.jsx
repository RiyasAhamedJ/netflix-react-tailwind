        ...
        <div className='max-w-[400px] h-[500px] mx-auto bg-black/50 text-white-100 rounded-xl shadow-orange-right shadow-orange-bottom shadow-orange-top shadow-orange-left'>
          ...
          <h1 className='text-3xl font-bold'>Sign In</h1>
            ...
            <form onSubmit={handleSubmit} className='w-full flex flex-col py-4'>
              ...
              />
              <button className='bg-orange-600 py-3 my-6 rounded font-bold text-black'>
                Sign In
              </button>
              ...
              <p className='py-8'>
              <span className='text-orange-600 px-1'>New to Netflix? </span>{' '}
              <Link to='/signup' className="text-gray-400"> Sign Up</Link>
              </p>
            </form>
          </div>
        </div>
